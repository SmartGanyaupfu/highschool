...
namespace HighSchool.API.Migrations
{
    ...
    [Migration("20230409125249_changedYearDataTypeForSchoolYear")]
    partial class changedYearDataTypeForSchoolYear
    {
            ...
            modelBuilder.Entity("HighSchool.Entities.Models.StudentRegistration", b =>
                {
                    ...
                    b.HasOne("HighSchool.Entities.Models.StudentClass", "StudentClass")
                        .WithMany()
                        .HasForeignKey("StudentClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
